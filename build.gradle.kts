...
val extensionHardeningKotlinSources = files(
    ...
    file("app/src/main/kotlin/dev/patrickgold/florisboard/ime/keyboard/KeyboardExtensionRepository.kt"),
...
val inheritedPlatformUtilityKotlinSources = fileTree(
    "app/src/main/kotlin/dev/patrickgold/florisboard/lib/util",
) {
    include("**/*.kt")
}
